...
public class Config {
  ...
  /* param in aggr function.like  mad_dd(s0,'epsilon'='0.001')  */
  private String QUERY_AGGREGATE_PARAM = "";
  /**
  ...
  public String getQUERY_AGGREGATE_PARAM() {
    return QUERY_AGGREGATE_PARAM;
  }

  public void setQUERY_AGGREGATE_PARAM(String QUERY_AGGREGATE_PARAM) {
    this.QUERY_AGGREGATE_PARAM = QUERY_AGGREGATE_PARAM;
  }
