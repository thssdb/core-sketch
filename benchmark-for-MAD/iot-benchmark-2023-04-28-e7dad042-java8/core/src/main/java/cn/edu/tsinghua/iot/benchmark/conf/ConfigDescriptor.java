  ...
  private void loadProps() {
    ...
    if (url != null) {
      ...
      try {
        ...
        config.SYN_TYPE = properties.getProperty("SYN_TYPE", config.SYN_TYPE);
        ...
        config.setQUERY_AGGREGATE_PARAM(
            properties.getProperty("QUERY_AGGREGATE_PARAM", config.getQUERY_AGGREGATE_PARAM()));
