...
public class ApproxAndSpaceLimitExp {
...
//                        +"\tSpace:\t"+space_core_single/TEST_CASE+"\t"+space_core/TEST_CASE+"\t"+space_dd/TEST_CASE+"\t"+space_tp/TEST_CASE+"\t"+space_exact/TEST_CASE);
            ...
            System.out.println("\tN:\t"+ size+"\tEpsilon:\t"+DDAlpha);
            System.out.println(dataset_name + "\texact core core_single dd tp");
            ...
            System.out.println(dataset_name + "\texact core_single");
            for (int j = 0; j < index; j++) {
